      ...
      <div class="row">
        ...
        <?php
            ...
            while($resultArray = mysqli_fetch_array($result))
            {
               ...
               echo '<td style="background-color:00334E;"><a href="'.$resultArray['link'].'" class="btn btn-primary d-flex justify-content-center" style="background-color: #00334E;">Register</a></td>';
               echo '</tr>';
